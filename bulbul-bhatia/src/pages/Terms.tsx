  ...
  const sections =
    locale === 'hi'
      ? [
          ...
          { title: 'बुकिंग एवं भुगतान', body: 'बुकिंग अनुरोध की पुष्टि बुलबुल भाटिया की टीम द्वारा की जाती है। भुगतान की शर्तें बुकिंग की पुष्टि के समय साझा की जाएंगी।' },
          ...
          { title: 'बौद्धिक संपदा', body: 'इस वेबसाइट की सामग्री, कोर्स सामग्री सहित, बुलबुल भाटिया की संपत्ति है और इसे अनुमति के बिना पुनः वितरित नहीं किया जा सकता।' },
      ...
      : [
          ...
          { title: 'Booking & Payment', body: 'Booking requests are confirmed by Bulbul Bhatia’s team. Payment terms will be shared at the time of booking confirmation.' },
          ...
          { title: 'Intellectual Property', body: 'Content on this website, including course materials, is the property of Bulbul Bhatia and may not be redistributed without permission.' },
